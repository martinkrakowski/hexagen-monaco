...
> `adobe-illustrator`, and the `adobe-firefly-storage-s3` presigner are **implemented**
> (through lightroom merged to `main`); the remaining 6 service addons + 2 storage presigners
