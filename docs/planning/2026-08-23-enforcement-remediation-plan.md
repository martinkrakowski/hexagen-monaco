...
**Status 2026-08-23: D-1 through D-6 accepted at their defaults.** The table is kept as the record of what each default means and the stated condition for revisiting it (D-1 wall-clock, D-3 timing, D-4 fix:allow ratio). Tranche 0 (P2.1, P4.1, P4.2) started the same day.
