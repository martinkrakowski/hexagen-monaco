...
| `packages/template-engine/src/infrastructure/generated/template-bundle.generated.ts` as a _second_ port owner | Mirror of templates; HEX-001 cites the template source              |
