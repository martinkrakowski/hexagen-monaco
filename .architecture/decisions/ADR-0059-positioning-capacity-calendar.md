...
1. **Architecture-remediation** — Phases 0–5 are complete. Phase 6 still has three legs (6.5(c), 6.7(a), 6.7(c)). Phase 7 has not started (7.1 → 7.6, strictly serial). Phase 8 remaining work is 8.12 (a–d, f–h; 8.12e landed) then 8.1 → 8.2. Legs 8.3–8.11 have landed. Recorded in `docs/planning/2026-08-17-remaining-work-summary.md`.
