...
Hexagen-Monaco is a modular monolith. Thirty-five bounded contexts live across five planes; the manifest at `.architecture/manifest.yaml` is the single source of truth.
