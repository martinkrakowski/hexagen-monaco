...
/**
 * True while the GitHub publish flow owns the prominent UI (dialog form, or a
 * github-destined exporting/success/error). Derived in one place so the Header
 * `open` condition and the status strip can't drift from the state machine.
 */
