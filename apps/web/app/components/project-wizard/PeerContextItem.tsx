  ...
  return (
    <div className="border rounded-lg p-4 space-y-4 bg-card">
      ...
      <button
        ...
        className="w-full py-2 text-sm text-destructive hover:text-destructive/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed border-t border-border"
      >
        Remove Peer Context
      </button>
    </div>
