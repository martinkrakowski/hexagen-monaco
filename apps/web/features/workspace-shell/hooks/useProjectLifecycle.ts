...
export function useProjectLifecycle(
  ...
  const { form, contentHash, ui, uiState, editor, totalSteps, onGoToStep } =
    options;
  ...
  const handleNext = useCallback(async () => {
    ...
    onGoToStep(nextStep);
  }, [ui, contentHash, totalSteps, onGoToStep, uiState, updateProject]);
  ...
  }, [contentHash, ui, editor, uiState, onGoToStep]);
