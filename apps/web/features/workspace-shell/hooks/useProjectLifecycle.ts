...
export function useProjectLifecycle(
  ...
  const handleManifestLoaded = useCallback(
    async (yamlContent: string) => {
      console.log("[handleManifestLoaded] called");
      const outcome = await importManifest(yamlContent);
      console.log(
        "[handleManifestLoaded] importManifest result:",
        outcome.kind,
      );
      if (outcome.kind === "success") {
        console.log(
          "[handleManifestLoaded] resetting form, entering edit mode",
        );
        ...
        console.log("[handleManifestLoaded] done");
      } else {
        console.error("[handleManifestLoaded] parse error:", outcome.message);
      }
    },
