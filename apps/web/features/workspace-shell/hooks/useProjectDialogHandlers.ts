...
export function useProjectDialogHandlers(
  ...
  const { form, ui, uiState, draft, clearDraft, saveProject, setActiveWorkspace, setSessionId } = options;
  ...
  const handleWelcomeManifestGenerated = useCallback(
    ...
    [uiState.kind, ui, handleManifestLoaded, saveProject, setActiveWorkspace, setSessionId, form],
  );
