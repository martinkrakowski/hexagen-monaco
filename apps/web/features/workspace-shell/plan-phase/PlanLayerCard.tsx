...
interface PlanLayerCardProps {
  ...
  /** Opens the delete confirm dialog (the actual removal is confirmed there). */
...
/**
 * One named planning layer: header (title, kind badge, turn count, updatedAt),
 * inline rename, delete + collapse controls, provenance badge, and — for
 * brainstorm layers — the "Extract decisions" action.
 */
