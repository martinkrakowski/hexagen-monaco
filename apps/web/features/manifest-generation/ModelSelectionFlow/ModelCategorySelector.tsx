...
interface ModelCategorySelectorProps {
  ...
  onCloudSelected: (provider: string, apiKey: string, remember: boolean) => void;
  onCancel: () => void;
}
      ...
      >
        ...
        <Tabs.Content value="local" className="space-y-4">
          ...
          <div className="text-sm text-muted-foreground">
            <p>Local models run directly in your browser without sending data to external services.</p>
