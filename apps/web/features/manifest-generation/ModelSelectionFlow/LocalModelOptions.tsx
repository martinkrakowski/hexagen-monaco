  ...
  if (isWebGPUSupported === false) {
    return (
      <div className="p-4 bg-amber-50 border border-amber-200 rounded-md">
        <h3 className="text-sm font-medium text-amber-800">WebGPU Not Supported</h3>
        <p className="text-sm text-amber-700 mt-1">
          Your browser doesn't support WebGPU, which is required for local models.
          Try using a recent version of Chrome or Edge, or use a cloud provider instead.
        </p>
