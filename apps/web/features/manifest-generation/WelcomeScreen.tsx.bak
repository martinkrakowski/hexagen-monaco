            ...
            <div className="mt-2 flex items-start gap-2">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  setOverrideModelCheck(checked === true)
                }
                className="mt-0.5"
              />
              <Label
              ...
              >
                Proceed anyway with the current model (results may be
                unreliable)
              </Label>
            </div>
            <div className="mt-3">
              <Button
                variant="outline"
                size="sm"
                onClick={() => actions.transitionTo("model_selection")}
              >
                Switch Model
              </Button>
            </div>
        ...
        {overrideModelCheck && modelNativelyCapable === false && (
          <div className="flex items-center gap-2 text-xs text-amber-600 dark:text-amber-400">
            <Checkbox
              ...
              checked={true}
              onCheckedChange={(checked) => {
                if (checked !== true) setOverrideModelCheck(false);
              }}
              className="h-3 w-3"
            />
            <Label
