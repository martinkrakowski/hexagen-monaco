  ...
  return (
    <div className="flex-shrink-0 p-2">
      ...
      <div className="relative flex w-full justify-between mb-4">
        <div className="absolute top-1/2 left-[14px] right-[14px] h-0.5 -translate-y-1/2 bg-muted z-0" />
        {currentStep > 1 && (
          <div
            className="absolute top-1/2 left-[14px] h-0.5 -translate-y-1/2 bg-primary z-0"
            style={{
