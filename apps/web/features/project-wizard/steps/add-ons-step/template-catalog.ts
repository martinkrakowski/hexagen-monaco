  ...
  },
  {
    ...
    details: {
      ...
      includes: [
        ...
        "/api/auth/me + src/lib/auth/getCurrentUser + requireAuth helpers",
      ],
    },
  },
  {
  ...
  },
  {
    ...
    details: {
      ...
      includes: [
        ...
        "Typed AdobeUser/IMSUserProfile + Microsoft Graph-style profile fetch in middleware",
        "Root middleware.ts protecting configured path prefixes",
        "/api/auth/me + src/lib/auth/getCurrentUser + requireAuth helpers",
      ],
    },
