import type { AdapterGenerationResponse } from "../out/manifest-generation.port.js";
...
export interface GenerateAdaptersToolPort {
  execute(input: GenerateAdaptersInput): Promise<GenerateAdaptersOutput>;
}
