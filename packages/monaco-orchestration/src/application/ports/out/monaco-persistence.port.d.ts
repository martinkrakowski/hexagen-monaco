...
export interface MonacoPersistencePort {
    loadLatestSession(projectId: string): Promise<Result<MonacoSession | null, PersistenceError>>;
    saveSession(session: MonacoSession): Promise<Result<MonacoSession, PersistenceError>>;
    listSessions(projectId: string, limit?: number): Promise<Result<SessionMetadata[], PersistenceError>>;
    deleteSession(sessionId: string): Promise<Result<void, PersistenceError>>;
    clearProjectSessions(projectId: string): Promise<Result<void, PersistenceError>>;
}
/**
...
//# sourceMappingURL=monaco-persistence.port.d.ts.map