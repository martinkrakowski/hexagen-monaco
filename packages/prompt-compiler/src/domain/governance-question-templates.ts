...
/**
 * GovernanceQuestionTemplates contains predefined questions that can be used
 * to help users understand and resolve architectural violations or suggestions.
 * These templates are used by the LLM to generate contextualized responses.
 */
...
/**
 * PrebakedQuestion represents a question template with an ID for reference
 */
...
/**
 * Violation represents an architectural rule violation detected during validation
 */
export interface Violation {
  /** Unique identifier for the violation */
  id: Identifier;
  /** Type of violation (error, warning, info) */
  type: "error" | "warning" | "info";
  /** Human-readable message describing the violation */
  message: string;
  /** Optional context about where the violation occurred */
  context?: string;
...
/**
 * AISuggestion represents an architectural improvement suggestion
 */
...
/**
 * WizardStepId represents the possible steps in the project configuration wizard
 */
...
/**
 * Predefined questions for responding to suggestions
 */
...
/**
 * Questions specific to each wizard step
 */
...
/**
 * Builds a prompt for explaining a violation to a user
 */
...
/**
 * Builds a prompt for responding to a suggestion
 */
...
/**
 * Builds a prompt for wizard step questions
 */
