 ...
 * This adapter converts the structured wizard data into a human-readable string that can be
 * included in system prompts to provide context about the current wizard state.
 */
export class WizardContextSerializerAdapter {
  /**
