...
import type { WriteStatus } from "./results.js";
...
export async function safeWriteFileAtomic(
  ...
  // PR-B1 (RCA #4): journal the pre-image BEFORE the mutation attempt — the
  // pre-read above already holds it. Over-recording is safe (a rollback of a
