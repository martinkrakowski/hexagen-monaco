// hexagen-monaco/packages/project-configuration/__tests__/infrastructure/adapters/render-manifest.test.ts
import assert from 'node:assert';
import { FakeRenderManifestPort } from '../../doubles/ports/render-manifest.fake';

/**
 * Minimal test suite for `FakeRenderManifestPort` in the `project-configuration` package.
