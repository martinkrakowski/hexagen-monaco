// hexagen-monaco/packages/project-configuration/__tests__/infrastructure/adapters/generate-project.test.ts

import assert from 'node:assert';
import { FakeGenerateProjectPort } from '../../doubles/ports/generate-project.fake';

/**
 * Minimal test suite for `FakeGenerateProjectPort` in the `project-configuration` package.
