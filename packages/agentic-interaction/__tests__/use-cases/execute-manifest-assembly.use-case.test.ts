  ...
  const state: Pick<PipelineState, "stage0" | "stage2" | "stage3" | "stage4"> = {
    ...
    stage2: {
      accepted: [
        ...
        { name: "payment-processing", type: "generic", reasoning: "Generic domain" },
      ],
      rejected: [],
      uncertain: [],
    },
      ...
      contexts: [
        {
          ...
          in: [{ name: "CreateOrderPort", type: "command", description: "Creates orders" }],
          out: [{ name: "OrderRepositoryPort", type: "repository", description: "Saves orders" }],
        },
      ],
    },
    stage4: {
      contexts: [
        {
          contextName: "order-management",
          adapters: [
            { name: "PostgresOrderAdapter", type: "Repository", implements: "OrderRepositoryPort" },
          ],
        },
      ],
    },
