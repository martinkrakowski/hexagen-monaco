// hexagen-monaco/packages/persistence/__tests__/infrastructure/adapters/generate-project.test.ts
import assert from "node:assert";
import { FakeGenerateProjectPort } from "../../doubles/ports/generate-project.fake";

/**
 * Minimal test suite for `FakeGenerateProjectPort` in the `persistence` package.
