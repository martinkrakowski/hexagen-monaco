// hexagen-monaco/packages/messaging/__tests__/doubles/ports/render-manifest.fake.ts
 ...
 *
 * Provides a `setBehavior` method so tests can inject a custom async implementation for `execute`.
 * If no custom behavior is set, the fake simply returns the input unchanged (echo).
 */
