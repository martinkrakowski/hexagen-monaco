hexagen-monaco/packages/messaging/__tests__/infrastructure/adapters/validate-spec.test.ts
// Minimal test suite for FakeValidateSpecPort in the messaging package.
